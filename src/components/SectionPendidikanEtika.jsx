...
const SectionPendidikanEtika = () => {
  ...
  style={{ backgroundImage: "url('/prajnaImages/background/5.png')" }} // <- Ganti di sini
>
        {/* Overlay */}
        ...
        <div className="relative max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 max-w-5xl mx-auto -mt-8">
            {[
              { src: "/prajnaImages/jilid1.png", title: "Jilid 1", subtitle: "Fondasi Moral" },
              { src: "/prajnaImages/jilid2.jpeg", title: "Jilid 2", subtitle: "Pengembangan Etika" },
              { src: "/prajnaImages/jilid3.png", title: "Jilid 3", subtitle: "Implementasi Nilai" },
            ].map((book, index) => (
              <motion.div
                key={index}
